...
class QuestionInputTabDisplay extends StatefulWidget {
  const QuestionInputTabDisplay({super.key});

  @override
  State<QuestionInputTabDisplay> createState() =>
      _QuestionInputTabDisplayState();
}

class _QuestionInputTabDisplayState extends State<QuestionInputTabDisplay> {
  @override
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Question Input'),
          bottom: TabBar(
            onTap: (value) {
              ...
              if (value == 0) {
                setState(() {
                  editFormKey.currentState?.fields['question']
                      ?.didChange(markdownData);
                });
              }
            },
            tabs: const <Widget>[
