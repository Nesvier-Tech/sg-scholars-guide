    ...
    <footer class="bg-sg-white dark:bg-gray-900">
        <div class="p-4 lg:py-8">
            <div class="sm:flex sm:items-center sm:justify-between">
                <nuxt-link to="login" class="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">2023 <a href="https://flowbite.com/"
                        class="hover:underline">Scholar's Guide</a>. All Rights Not Yet Reserved.
                </span>
