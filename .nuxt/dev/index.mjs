...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file://E:/scholars_guide/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://E:/scholars_guide/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://E:/scholars_guide/node_modules/devalue/index.js';
import { renderToString } from 'file://E:/scholars_guide/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://E:/scholars_guide/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://E:/scholars_guide/node_modules/ofetch/dist/node.mjs';
import destr from 'file://E:/scholars_guide/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://E:/scholars_guide/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://E:/scholars_guide/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://E:/scholars_guide/node_modules/scule/dist/index.mjs';
import { klona } from 'file://E:/scholars_guide/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://E:/scholars_guide/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://E:/scholars_guide/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://E:/scholars_guide/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://E:/scholars_guide/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/scholars_guide/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/scholars_guide/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file://E:/scholars_guide/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://E:/scholars_guide/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://E:/scholars_guide/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"E:/scholars_guide/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\scholars_guide","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\scholars_guide\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\scholars_guide\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\scholars_guide\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\scholars_guide\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _7BKYPZxFmh = (function(nitro) {
...
const _lazy_0xMIBk = () => Promise.resolve().then(function () { return renderer$1; });
...
const getClientManifest = () => import('file://E:/scholars_guide/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://E:/scholars_guide/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
